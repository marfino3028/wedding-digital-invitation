"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["node_modules_add-to-calendar-button-vue_dist_AddToCalendarButtonComponent-91e5a023_js"],{

/***/ "./node_modules/add-to-calendar-button-vue/dist/AddToCalendarButtonComponent-91e5a023.js":
/*!***********************************************************************************************!*\
  !*** ./node_modules/add-to-calendar-button-vue/dist/AddToCalendarButtonComponent-91e5a023.js ***!
  \***********************************************************************************************/
...
function ae(e, n, t) {
  ...
  const o = n + "T" + t + ":00", l = new Date(o), r = l.getFullYear(), a = l.getMonth() + 1, c = l.getDate(), h = l.getHours(), p = i[1].replace(/[^\w_\-:,;=+/<br>]/g, "").split("<br>"), s = { 1: {}, 2: {} };
  let g = 0;
  for (let d = 0; d < p.length; d++)
    if (p[`${d}`].startsWith("TZOFFSETTO") && (g++, s[`${g}`].offset = p[`${d}`].split(":")[1]), p[`${d}`].startsWith("DTSTART") && (s[`${g}`].hour = parseInt(p[`${d}`].substr(17, 2))), p[`${d}`].startsWith("RRULE")) {
      let y = p[`${d}`].split(";"), Y = parseInt(y[1].split("=")[1]);
 ...
 *
 */
const Ae = "1.18.8", R = () => !(typeof window > "u"), D = R() ? () => !!(/iPad|iPhone|iPod/i.test(navigator.userAgent || navigator.vendor || window.opera) && !window.MSStream || navigator.platform === "MacIntel" && navigator.maxTouchPoints > 1) : () => !1, ye = R() ? () => !!(/android/i.test(navigator.userAgent || navigator.vendor || window.opera) && !window.MSStream) : () => !1, ve = R() ? () => !!/chrome|chromium|crios|google inc/i.test(navigator.userAgent || navigator.vendor) : () => !1, Se = () => !!(ye() || D()), ee = R() ? () => !!/(; ?wv|(iPhone|iPod|iPad).*AppleWebKit(?!.*Safari))/i.test(navigator.userAgent || navigator.vendor) : () => !1, ze = R() ? () => !!/(Instagram)/i.test(navigator.userAgent || navigator.vendor || window.opera) : () => !1, ie = ee() ? "_system" : "_blank", Re = ["apple", "google", "ical", "ms365", "outlookcom", "msteams", "yahoo"], Be = ["apple", "google", "ical"], Ue = ["msteams"], $e = ["ical"], _ = [], $ = {
...
function xe(e) {
  D() && e.options.includes("ical") && !e.options.includes("apple") && e.options.push("apple");
  const n = [];
  e.optionLabels = [];
  for (let t = 0; t < e.options.length; t++) {
    ...
    D() && $e.includes(o) || e.recurrence != null && e.recurrence != "" && (!Be.includes(o) || e.recurrence_until != null && e.recurrence_until != "" && (o == "apple" || o == "ical")) || e.subscribe && Ue.includes(o) || (n.push(o), e.optionLabels.push(l));
  }
...
function Ve(e) {
  if (e.dates != null && e.dates.length > 0)
    for (let t = 0; t < e.dates.length; t++) {
      ...
      e.dates[`${t}`].startTime = i.startTime, e.dates[`${t}`].endTime = i.endTime, e.dates[`${t}`].timeZone = i.timeZone, e.dates[`${t}`].timestamp = i.startTimestamp, e.dates[`${t}`].startDate = I(i.startDate), e.dates[`${t}`].endDate = I(i.endDate);
    }
  else {
    const t = se(e);
    e.dates = [], e.dates[0] = new Object(), e.startTime = e.dates[0].startTime = t.startTime, e.endTime = e.dates[0].endTime = t.endTime, e.timeZone = e.dates[0].timeZone = t.timeZone, e.startDate = e.dates[0].startDate = I(t.startDate), e.endDate = e.dates[0].endDate = I(t.endDate);
  }
  const n = new Date();
  return (e.created == null || e.created == "") && (e.created = L(n, "clean", !0)), (e.updated == null || e.updated == "") && (e.updated = L(n, "clean", !0)), e;
}
function We(e) {
  return (e.status == null || e.status == "") && (e.status = "CONFIRMED"), (e.sequence == null || e.sequence == "") && (e.sequence = 0), e;
}
function Je(e, n) {
  return e.dates[`${n}`].description != null && e.dates[`${n}`].description != "" ? (e.dates[`${n}`].descriptionHtmlFree = F(e.dates[`${n}`].description, !0), e.dates[`${n}`].description = F(e.dates[`${n}`].description)) : e.dates[`${n}`].description == null && e.description != null && e.description != "" ? (e.dates[`${n}`].descriptionHtmlFree = F(e.description, !0), e.dates[`${n}`].description = F(e.description)) : e.dates[`${n}`].descriptionHtmlFree = e.dates[`${n}`].description = "", e;
}
function Xe(e) {
...
function v(e, n = "", t = "", i = !1, o = !1) {
  e == "open" ? ce(n, t, i, o) : e == "close" || t.classList.contains("atcb-active") || document.querySelector(".atcb-active-modal") ? P(i) : ce(n, t, i, o);
}
function ce(e, n, t = !1, i = !1) {
  ...
  if (e.listStyle === "modal")
    document.body.appendChild(r), r.appendChild(o), e.branding, G(o, e.sizes), le();
  else {
    const a = document.createElement("div");
    a.id = "atcb-pos-wrapper", a.style.position = "absolute", a.style.top = "0", a.style.bottom = "0", a.style.width = "100%", document.body.appendChild(a), a.appendChild(l), l.appendChild(o), e.buttonStyle != "" && l.classList.add("atcb-style-" + e.buttonStyle), e.branding, document.body.appendChild(r), G(o, e.sizes), l.style.display = "none", setTimeout(function() {
      l.style.display = "block", e.listStyle === "dropdown-static" ? Q(n, l, !0) : Q(n, l);
    }, 5);
  }
  ...
  switch (t) {
    ...
    case "yahoo":
      n.id = e.identifier + "-" + t, n.addEventListener(
        "click",
        z(() => {
          l ? n.blur() : v("close"), j(t, e);
        })
      ), n.addEventListener("keyup", function(r) {
        r.key == "Enter" && (r.preventDefault(), l ? n.blur() : v("close"), j(t, e, "all", !0));
      });
      break;
    case "close":
...
function gn(e, n) {
  ...
  t.classList.add("atcb-button-wrapper"), t.classList.add("atcb-" + n.lightMode), n.rtl && t.classList.add("atcb-rtl"), e.appendChild(t), G(t, n.sizes);
  ...
  if (i.classList.add("atcb-button"), n.textLabelButton == !1 && i.classList.add("atcb-no-text"), n.trigger === "click" && i.classList.add("atcb-click"), n.listStyle === "overlay" && i.classList.add("atcb-dropoverlay"), i.type = "button", t.appendChild(i), n.buttonStyle == "date" && Ye(n, i), n.options.length === 1)
    i.classList.add("atcb-single"), q(n, i, n.options[0], n.iconButton, n.label, !0);
  else {
    q(n, i, "trigger", n.iconButton, n.label);
...
`);
  ...
  for (let l = 0; l < e.dates.length; l++) {
    ...
    const a = E(e.dates[`${l}`], "delimiters", "general", !0);
...
function yn(e) {
  ...
  if (e.options.forEach(function(i) {
    const o = document.createElement("div");
    o.classList.add("atcb-list-item"), o.tabIndex = 0, t++, o.dataset.optionNumber = t, n.appendChild(o), q(e, o, i, e.iconList, e.optionLabels[t - 1]);
  }), e.listStyle === "modal") {
    const i = document.createElement("div");
    i.classList.add("atcb-list-item", "atcb-list-item-close"), i.tabIndex = 0, n.appendChild(i), q(e, i, "close", e.iconList);
  }
  return n;
}
...
function O(e, n = "", t, i = "", o = [], l = [], r = !1) {
  ...
  const p = document.getElementById(e.identifier);
  p != null && p.classList.add("atcb-active-modal");
  const s = document.createElement("div");
  if (s.classList.add("atcb-modal-box"), s.classList.add("atcb-" + e.lightMode), e.rtl && s.classList.add("atcb-rtl"), c.appendChild(s), G(s, e.sizes), re(a), n != "" && e.iconModal == !0) {
...
function ue(e, n) {
  K(e.identifier), j("yahoo2nd", e, "all", n);
}
function Ye(e, n, t = "all") {
  t != "all" ? t = parseInt(t) - 1 : e.dates.length == 1 && (t = 0);
  const i = function() {
    let b, C, d, y, Y = {}, U = {};
    t == "all" ? (Y = E(e.dates[0]), U = E(e.dates[e.dates.length - 1]), d = e.dates[0].timeZone, y = e.dates[e.dates.length - 1].timeZone) : (Y = E(e.dates[`${t}`]), U = Y, d = e.dates[`${t}`].timeZone, y = d), b = new Date(Y.start), C = new Date(U.end), (d == null || d == "" || Y.allday) && (d = "UTC"), (y == null || y == "" || U.allday) && (y = "UTC");
    let w = "", V = "", W = "";
    !Y.allday && Intl.DateTimeFormat().resolvedOptions().timeZone != d && d != y && (V = " (" + d + ")"), (!U.allday && Intl.DateTimeFormat().resolvedOptions().timeZone != y || d != y) && (W = " (" + y + ")");
    const Z = de(d), N = de(y);
    return b.toLocaleDateString(e.language, N.DateLong) === C.toLocaleDateString(e.language, N.DateLong) ? Y.allday ? w = b.toLocaleDateString(e.language, Z.DateShort) : w = b.toLocaleString(e.language, Z.DateTimeShort) + V + " - " + C.toLocaleTimeString(e.language, N.Time) + W : (Y.allday ? w = b.toLocaleDateString(e.language, Z.DateShort) : w = b.toLocaleString(e.language, Z.DateTimeShort), w += V + " - ", U.allday ? w += C.toLocaleDateString(e.language, N.DateLong) : w += C.toLocaleString(e.language, N.DateTimeLong), w += W), w;
  }(), o = function() {
  ...
  t == "all" && (t = 0);
  const r = new Date(E(e.dates[`${t}`]).start), a = function() {
  ...
  p.classList.add("atcb-date-btn-month"), h.textContent = r.toLocaleString(e.language, {
    day: "numeric",
    timeZone: a
  }), p.textContent = r.toLocaleString(e.language, {
    month: "short",
    timeZone: a
  }), c.appendChild(p);
  const s = document.createElement("div");
  ...
  if (T.classList.add("atcb-date-btn-headline"), T.textContent = e.dates[`${t}`].name, g.appendChild(T), e.location != null && e.location != "" || l != "") {
    ...
    if (b.classList.add("atcb-date-btn-content"), g.appendChild(b), l != "")
      b.textContent = l, b.style.fontWeight = "600", b.style.color = "#9c1a23";
    else {
      b.classList.add("atcb-date-btn-content-location");
      const C = document.createElement("span");
      C.classList.add("atcb-date-btn-content-icon"), C.innerHTML = $.location, b.appendChild(C);
      const d = document.createElement("span");
      d.textContent = e.location, b.appendChild(d);
    }
  }
  const u = document.createElement("div");
  ...
  if (m.textContent = i, u.appendChild(m), e.recurrence != null && e.recurrence != "") {
    ...
    b.classList.add("atcb-date-btn-content-recurr-icon"), u.appendChild(b), b.innerHTML = "&#x27F3;";
  }
  const S = document.createElement("div");
  if (S.classList.add("atcb-date-btn-hover"), S.innerHTML = o, s.appendChild(S), e.checkmark) {
    const b = document.createElement("div");
    b.classList.add("atcb-checkmark"), b.innerHTML = $.checkmark, n.appendChild(b);
  }
}
function de(e) {
  return {
...
function Sn(e, n, t) {
  ...
  switch (e) {
    ...
    case "ical":
      ...
      break;
    case "google":
      Cn(i.replace("webcal://calendar.google.com/calendar/u/2?cid=", ""));
      break;
    case "ms365":
      me(i, n.name);
      break;
...
function Cn(e) {
  B("https://calendar.google.com/calendar/r?cid=" + e);
}
function me(e, n, t = "365") {
  ...
  i.push("url=" + encodeURIComponent(e)), i.push("name=" + encodeURIComponent(n)), B(o + i.join("&"));
}
function Yn(e) {
  const n = [];
  ...
  n.push("uid=" + encodeURIComponent(e.uid)), B(n.join("&"));
}
function En(e) {
  const n = [];
  ...
  ), t.allday && n.push("dur=allday"), e.name != null && e.name != "" && n.push("title=" + encodeURIComponent(e.name)), e.location != null && e.location != "" && n.push("in_loc=" + encodeURIComponent(e.location)), e.descriptionHtmlFree != null && e.descriptionHtmlFree != "" && n.push("desc=" + encodeURIComponent(e.descriptionHtmlFree)), B(n.join("&"));
}
function fe(e, n = "365") {
...
function wn(e) {
  ...
  let o = "";
  e.location != null && e.location != "" && (o = encodeURIComponent(e.location), n.push("location=" + o), o += " // "), e.descriptionHtmlFree != null && e.descriptionHtmlFree != "" && n.push("content=" + o + encodeURIComponent(e.descriptionHtmlFree)), n.push("uid=" + encodeURIComponent(e.uid)), B(t + n.join("&"));
}
function B(e, n = "") {
...
function Ee(e, n = "all", t = !1) {
  ...
  for (let s = c; s <= h; s++) {
    const g = E(e.dates[`${s}`], "clean", "ical"), T = function() {
      if (g.allday)
        return ";VALUE=DATE";
    ...
    if (r.push("BEGIN:VEVENT"), r.push("UID:" + e.dates[`${s}`].uid), r.push("DTSTAMP:" + L(l, "clean", !0)), r.push("DTSTART" + T + ":" + g.start), r.push("DTEND" + T + ":" + g.end), r.push("SUMMARY:" + e.dates[`${s}`].name.replace(/.{65}/g, `$&\r
...
function E(e, n = "delimiters", t = "general", i = !1) {
  if (e.startTime != null && e.startTime != "" && e.endTime != null && e.endTime != "") {
    ...
    if (e.timeZone != null && e.timeZone != "") {
      ...
      const p = ae(e.timeZone, e.startDate, e.startTime), s = ae(e.timeZone, e.endDate, e.endTime);
      if (i) {
        const u = p.slice(0, 3) + ":" + p.slice(3), A = s.slice(0, 3) + ":" + s.slice(3);
        return {
      ...
      const g = parseInt(p[0] + 1) * -1 * ((parseInt(p.substr(1, 2)) * 60 + parseInt(p.substr(3, 2))) * 60 * 1e3), T = parseInt(s[0] + 1) * -1 * ((parseInt(s.substr(1, 2)) * 60 + parseInt(s.substr(3, 2))) * 60 * 1e3);
...
function L(e, n = "delimiters", t = !0, i = !1) {
  const o = function() {
...
function ne(e) {
  ...
  if (n.value = e, n.contentEditable = !0, n.readOnly = !1, D()) {
...
function f(e, n) {
  ...
  return n.customLabels != null && n.customLabels[`${t}`] != null && n.customLabels[`${t}`] != "" ? F(n.customLabels[`${t}`]) : Rn(e, n.language);
}
function Rn(e, n) {
  ...
  R() && (document.addEventListener("keyup", function(e) {
    ...
    pe(() => {
      ...
      if (e != null) {
        ...
        n != null && n.classList.contains("atcb-mind-scrolling") && Q(e, n, !1, !0);
      }
    }, 20)
  ));
}
...
const Fn = {
  ...
  mounted() {
    this.setStyle(), M = ge(), console.warn("The Add to Calendar Button Vue Wrapper got deprecated!"), console.warn("Please upgrade to the latest version of the official Add to Calendar Button package at https://github.com/add2cal/add-to-calendar-button !");
  },
  beforeUpdate() {
    M[0] != null && document.getElementById(M[0]) != null && (Bn(M[0]), this.setStyle(), this.instance++);
  },
  updated() {
    M = ge();
  }
}, Zn = /* @__PURE__ */ (0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
  ...Fn,
  setup(e) {
    return { get initializedButtons() {
      return M;
    }, set initializedButtons(n) {
      M = n;
    } };
  }
});
